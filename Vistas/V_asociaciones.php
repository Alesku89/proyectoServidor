    ...
    <div style="background-color: greenyellow;">
        <div class="container">
            <table class="table" style="border-bottom: darkgreen;">
                ...
                <tbody>
                    <?php
                        require('../Controlador/C_getAsociaciones.php');

                        foreach ($asociaciones as $asociacion) {
                            echo "<tr>";
                            echo "<td>" . $asociacion['Asociacion'] . "</td>";
                            echo "<td>" . $asociacion['CIF'] . "</td>";
                            echo "<td>" . $asociacion['domicilio'] . "</td>";
                            echo "<td>" . $asociacion['mapa'] . "</td>";
                            echo "<td>
                                    <form method='GET' action='V_donacion.php'>
                                        <input type='hidden' value=" . $asociacion['CodAso'] . " name='CodAso'>
                                        <input class='btn btn-success' type='submit' value='Donar a esta asociación'>
                                    </form>
                                  </td>";
                            echo "</tr>";
                        }
