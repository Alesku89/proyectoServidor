    ...
    <div style="background-color: greenyellow;">
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade">
            <div class="carousel-inner">
                <?php
                    require('../Controlador/C_getGatos.php');
                    ...
                    foreach ($gatos as $gato) {
                        ...
                        echo    '<div class="carousel-item" >
                                    <img src="../img/Gatos/'.$gato["nombre"].'.jpg" class="d-block w-100" >
                                    <div class="container text-center" style="padding-bottom:1vh;">
                                        <p style="padding-top: 1vh;"><b>Nombre: </b>' . $gato['nombre'] . '</p><p><b>Raza: </b>' . $gato['raza'] . '</p><p><b>Asociación: </b>' . $gato['asociacion'] . '</p>

                                        <form method="POST" action="../Controlador/C_adopcion.php">
                                            <input type="hidden" name="CodAni" value='.$gato["CodAni"].'>
                                            <input type="hidden" name="Seq_Usuario" value='.$_SESSION['usuario'].'>
                                            <input type="hidden" name="CodAso" value='.$gato["CodAso"].'>
