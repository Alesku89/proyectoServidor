...
<body class="container">
    ...
    <div style="background-color: greenyellow;">
        <div class="container">
            <div>
                <h1>Funciones:</h1>
                <a class="nav-link" href="#">Modificar mis datos</a>
                <a class="nav-link" href="V_adopcionUsuario.php">Ver mis adopciones</a>
                <a class="nav-link" href="V_donacionUsuario.php">Ver mis donaciones</a>
