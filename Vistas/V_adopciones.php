    ...
    <div style="background-color: greenyellow;">
        <div class="container">
            <table class="table" style="border-bottom: darkgreen;">
                ...
                <tbody>
                    <?php
                        require('../Controlador/C_getAdopciones.php');

                        foreach ($adopciones as $adopcion) {
                            echo "<tr>";
                            echo "<td>" . $adopcion['DNI'] . "</td>";
                            echo "<td>" . $adopcion['nombre'] . "</td>";
                            echo "<td>" . $adopcion['apellidos'] . "</td>";
                            echo "<td>" . $adopcion['Descripcion'] . "</td>";
                            echo "<td>" . $adopcion['aninombre'] . "</td>";
                            echo "<td>" . $adopcion['fecha'] . "</td>";
                            echo "</tr>";
                        }
                    ?>
                </tbody>
