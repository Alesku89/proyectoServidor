...
<body class="container">
    ...
    <div style="background-color: greenyellow;">
        <div class="container">
            <div>
                <h1>Funciones:</h1>
                <a class="nav-link" href="#">Dar alta asociación</a>
                <a class="nav-link" href="V_usuarios.php">Ver usuarios</a>
                <a class="nav-link" href="V_adopciones.php">Ver adopciones</a>
                <a class="nav-link" href="V_donaciones.php">Ver donaciones</a>
                <a class="nav-link" href="V_estadisticas.php">Estadísticas</a>
